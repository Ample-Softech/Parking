			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Kothrud, Pune, Maharashtra&lat=18.5073985&lng=73.80765040000006"><p>Kothrud, Pune</p></a>
        				</div>	
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Karve Nagar, Pune, Maharashtra&lat=18.4897587&lng=73.82029620000003"><p>Karvenagar, Pune</p></a>
       	 				</div>	
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Chinchwad, Maharashtra&lat=18.6297811&lng=73.79970939999998"><p>Chinchwad, Pune</p></a>
        				</div>	
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Deccan Gymkhana, Pune, Maharashtra&lat=18.5175566&lng=73.84166000000005"><p>Deccan-Gymkhana, Pune</p></a>
        				</div>	
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Sadashiv Peth, Pune, Maharashtra&lat=18.5083218&lng=73.84656480000001"><p>Sadashiv Peth, Pune</p></a>
        				</div>	
        			</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Senapati Bapat Road, Sheti Mahamandal, 30, Laxmi Society, Pune, Maharashtra&lat=18.5316664&lng=73.83010739999997"><p>Senapati Bapat Road, Pune</p></a>
        				</div>	
        			</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Shaniwar Peth, Pune, Maharashtra&lat=18.5194431&lng=73.85193559999993"><p>Shaniwar Peth, Pune</p></a>
        				</div>	
       	 			</div>
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 cards">
					<div class="cardImg">
        				...
        				<div class="caption" style="color: white;">
          					<a class="imglinks" href="/Parking/Check.basic?loc=Sinhagad Road, Amarendra Society, Bank Of India Colony, Pune, Maharashtra&lat=18.4571738&lng=73.80336820000002"><p>Sinhgad Road, Pune</p></a>
       	 				</div>	
        			</div>
				</div>
			</div>
